...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 17 18:30:36 2020
...
for cnt_ind in range(len(isos)):
    ...
    for pro_std in range(len(PROT_STD)):
        ...
        for year in range(len(years)):
            ...
            dataDF.iloc[line_counter, 16 + pro_std] = rf.fv_annual[year,0]
            
            line_counter+=1
    #if args.RF_model == 'lpjml':
        #dataDF.to_csv('output_{}_{}_fullProt_lpjml_long_2y.csv'.format(args.RF_model, args.CL_model))
    #else:
    dataDF.to_csv('output_{}_{}_0flopros_FLD03_19_02.csv'.format(args.RF_model, args.CL_model))
