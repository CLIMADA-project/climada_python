...
for cnt_ind in range(len(isos)):
    ...
    for scen in range(len(SCENARIO)):
        ...
        for year in range(len(years)):
            print('country_{}_year{}_scenario_{}'.format(country[0], str(years[year]), SCENARIO[scen]))
