...
- `climada.hazard.tc_tracks.Basin_bounds_storm` Enum class `climada.hazard.tc_tracks.subset_by_basin` function [#1031](https://github.com/CLIMADA-project/climada_python/pull/1031)
