...
class MCACalc:
    def __init__(
        ...
        self._whole_criteria_set = criteria_set
        self._current_criteria_set = criteria_set

    @property
    def criteria_set(self):
        return self._current_criteria_set

    def add_criteria(self, criteria: Criterion | list[Criterion]):
        self.criteria_set.add_criteria(criteria)

    def help(self): ...

    def select_criteria(self, criteria: Criterion | list[Criterion]): ...

    def apply_constraint(self): ...

    def resolve_dominance(self, mcdm_methods: list[str]): ...

    def calc_ranking(self, mcdm_method): ...
