...
class TestCaliforniaFirms(unittest.TestCase):
    ...
    def test_hist_pass(self):
        ...
        self.assertEqual(bf.event_name, ['1', '2', '3', '4', '5', '6', '7', '8', '9'])
        self.assertTrue(np.allclose(bf.frequency, np.ones(9)))
        self.assertEqual(bf.intensity.shape, (9, 19734))
        self.assertEqual(bf.fraction.shape, (9, 19734))
        self.assertEqual(bf.intensity[1, :].nonzero()[1][0], 12962)
        self.assertEqual(bf.intensity[3, :].nonzero()[1][0], 56)
        self.assertEqual(bf.intensity[5, :].nonzero()[1][0], 8913)
        self.assertEqual(bf.intensity[5, :].nonzero()[1][1], 8914)
        self.assertEqual(bf.intensity[5, :].nonzero()[1].size, 2)
        self.assertEqual(bf.intensity[6, :].nonzero()[1][0], 9489)
        self.assertEqual(bf.intensity[6, :].nonzero()[1].size, 1)
        self.assertEqual(bf.intensity[7, :].nonzero()[1][0], 8622)
        self.assertEqual(bf.intensity[7, :].nonzero()[1].size, 3)
        self.assertAlmostEqual(bf.intensity[0, 19003], 316.2)
        self.assertAlmostEqual(bf.intensity[2, 2008], 303.3)
        self.assertAlmostEqual(bf.intensity[2, 6184], 354.2)
        self.assertAlmostEqual(bf.intensity[7, 8765], 300.3)
        self.assertAlmostEqual(bf.fraction.max(), 1.0)
        self.assertAlmostEqual(bf.fraction.min(), 0.0)
    ...
    def test_synth_pass(self):
        ...
        self.assertEqual(bf.intensity.shape, (27, 19734))
        self.assertEqual(bf.fraction.shape, (27, 19734))
