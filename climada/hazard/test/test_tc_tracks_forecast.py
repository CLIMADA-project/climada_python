...
class TestECMWF(unittest.TestCase):
    ...
    def test_fetch_ecmwf(self):
        ...
        self.assertEqual(forecast.data[0].central_pressure[0], 100000.)
        ...
        self.assertEqual(forecast.data[0].central_pressure_unit, 'Pa')
        ...
        self.assertEqual(forecast.data[0].category, -1)
