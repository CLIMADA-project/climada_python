...
class TestReader(unittest.TestCase):
    ...
    def test_wrong_centroid_error(self):
        ...
        size """
        # Read demo excel file
        read_cen = Centroids(HAZ_DEMO_MAT)
        ...
        with self.assertRaises(ValueError):
            hazard.read(HAZ_DEMO_MAT, 'TC', centroids=read_cen)
    ...
    def test_wrong_hazard_type_error(self):
        ...
        hazard = Hazard()
        with self.assertRaises(ValueError):
            hazard.read(HAZ_DEMO_MAT, 'WS')

    def test_centroid_hazard_pass(self):
        """ Read centroid separately from the hazard """
        # Read demo excel file
        description = 'One single file.'
        centroids = Centroids(HAZ_DEMO_MAT, description)
        hazard = Hazard()
        hazard.read(HAZ_DEMO_MAT, 'TC', description, centroids)
