...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 12 17:43:16 2020
...
class GDP2AssetDis(Exposures):
    ...
    def set_countries(self, countries=[], reg=[], ref_year=2000,
                      path=DEMO_GDP2ASSET, dis_map = None):
    ...
    @staticmethod
    def _set_one_country(countryISO, ref_year, path=DEMO_GDP2ASSET, dis_map= None):
        ...
        assets = _read_GDP(coord, ref_year, path, dis_map)
...
def _read_GDP(shp_exposures, ref_year, path=DEMO_GDP2ASSET, disMap = None):
