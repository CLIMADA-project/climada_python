...
from climada.entity.exposures.base import DEF_VAR_MAT, Exposures
...
class TestReader(unittest.TestCase):
    ...
    def test_read_demo_pass(self):
        ...
        self.assertIn("int", str(expo.hazard_impf().dtype))
        self.assertEqual(expo.hazard_impf().shape, (n_expos,))
        self.assertEqual(expo.hazard_impf()[0], 1)
        self.assertEqual(expo.hazard_impf()[n_expos - 1], 1)
        ...
        self.assertIn("int", str(expo.hazard_centroids().dtype))
        self.assertEqual(expo.hazard_centroids().shape, (n_expos,))
        self.assertEqual(expo.hazard_centroids()[0], 47)
        self.assertEqual(expo.hazard_centroids()[n_expos - 1], 46)
